  ...
  return (
    <div className="welkom-root">
      ...
      <main className="welkom-content" id="top">
        ...
        {WORK.map((item, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Project meta — alternates lower-left / upper-right */}
              <div
                className="absolute flex flex-col gap-1"
                style={
                  isLeft
                    ? { bottom: "8vh", left: "5vw" }
                    : { top: "8vh", right: "5vw", alignItems: "flex-end" }
                }
              >
                <span
              ...
              {/* Blurb caption — opposite corner */}
              <p
                className="caption absolute serif-italic leading-[1.5]"
                style={{
                  ...(isLeft
        ...
        <section
          id="contact"
          className="section-dark relative px-6 py-36 md:px-12 md:py-52"
        >
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3" style={{ borderTop: "1px solid rgba(244,232,210,0.18)" }}>
              ...
              <a
                href="tel:+31302345678"
                className="reveal delay-1 group block py-9 md:py-10 md:px-10"
                style={{
                  borderBottom: "1px solid rgba(244,232,210,0.12)",
                  borderInline: "1px solid rgba(244,232,210,0.12)",
                }}
              >
                <p
                  className="serif-italic"
